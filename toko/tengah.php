...
elseif ($_GET[module]=='pemesanan'){
  echo "<div class='login-box'>
  		<h2>Hubungi Kami</h2>    
		Kami Menerima Pemesanan sparepart, baik itu mesin cuci, kulkas dan sebagainya, Anda dapat menghubungi Kami lewat Form di bawah ini      
          <div class='details_big_box'>
...
if (empty($_SESSION[username]) AND empty($_SESSION[password])) {
  ...
  echo "<div class='login-box'>
		...
		<tr><td>Nomor Handphone</td><td> : $r[telepon]</td></tr>
...
//modul pengaduan atau perubahan pemesanan
...
if (empty($_SESSION[username]) AND empty($_SESSION[password])) {
  ...
  echo "<div class='login-box'>
		...
		<tr><td>Alamat Anda</td><td> : $r[alamat]</td></tr>
		<tr><td colspan=2>
		<br/><b>Silahkan Isi Pengaduan Anda Dibawah Ini</b><br>
        <tr><td>Permasalahan</td><td>  <input type=text name=subjek size=40></td></tr>
        <tr><td valign=top>Keterangan</td><td> <textarea name=pesan  style='width: 390px; height: 160px;'></textarea><br/>
		<i></i> </td></tr>
        <tr><td>&nbsp;</td><td><img src='captcha.php'></td></tr>
        <tr><td>&nbsp;</td><td>(masukkan 6 kode di atas)<br /><input type=text name=kode size=6 maxlength=6><br /></td></tr>
        </td><td colspan=2><input type=submit name=submit value=Kirim class='button' ></td></tr>
        ...
        <div class='center_prod_box_big'>            
          ...
          <div class='details_big_box'>
            <div class='product_title_big'>Terimakasih</div>
              <div>
              <br />Terimakasih telah menghubungi kami.<br /><br /> Kami akan segera Merespon Anda.
              </div>
          </div>    
          </div>
            <div class='bottom_prod_box_big'></div>
...
elseif ($_GET[module]=='profilKustomer') {
	...
	<h2>Profil Saya</h2>
      ...
      <tr><td>Nomor Handphone</td><td> $p[telepon]</td></tr>
...
<h2>Form Edit Your Profil</h2>
      ...
      <tr><td>Nomor Handphone</td><td>  <input type=text name=telepon value='$e[telepon]'></td></tr>
...
elseif (empty($_POST[nama]) || empty($_POST[password]) || empty($_POST[alamat]) || empty($_POST[telepon]) || empty($_POST[email]) || empty($_POST[kota]) || empty($_POST[kode])){
...
mysql_query("INSERT INTO kustomer(nama_lengkap, password, alamat, telepon, email, id_kota) 
             VALUES('$_POST[nama]','$password','$_POST[alamat]','$_POST[telepon]','$_POST[email]','$_POST[kota]')");
...
<h2>Form Register</h2>
      ...
      <br /> Alamat pengiriman harus di isi lengkap, termasuk kota/kabupaten dan kode posnya.</td></tr>
      <tr><td>Nomor Telepon</td><td>  <input type=text name=telepon></td></tr>
      <tr><td>Email</td><td>  <input type=text name=email size=30></td></tr>
      <tr><td valign=top>Kota Tujuan</td><td>   
      <select name='kota'>
      <option value=0 selected>- Pilih Kota -</option>";
...
";                      
  ...
  echo "<h2>Kustomer Baru</h2>";
      ...
      <tr><td>Alamat Pengiriman</td><td>  <textarea name=alamat></textarea>
      <br /> Alamat pengiriman harus di isi lengkap, termasuk kota/kabupaten dan kode posnya.</td></tr>
      <tr><td>Nomor Handphone</td><td>  <input type=text name=></td></tr>
      <tr><td>Email</td><td>  <input type=text name=email size=30></td></tr>
      <tr><td valign=top>Kota Tujuan</td><td>   
      <select name='kota'>
      <option value=0 selected>- Pilih Kota -</option>";
...
$pesan="Terimakasih telah melakukan pemesanan online di toko online kami <br /><br />  
        ...
        Alamat: $r[alamat] <br/>
        Nomor Handphone: $r[telepon] <br /><hr />
