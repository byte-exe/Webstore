	...
	?>
      ...
      while($a=mysql_fetch_array($best)){
        ...
        <div class="latest-product ">
            ...
            ?>
			Kami Menjual Sparepart Berbagai Elektronik 
...
<div class="plugin">             
    ...
    <div class="page">
        ...
        <div class="copyright">
              <ul>
            <li>&copy; 2021 </li>
            <li><a href="#" class="select"> Frista Elektronik</a> All Rights Reserved.</li>
            <li><a href="http://" class="select"> Muhammad Rizal Wardana </a> All Rights Reserved.</li>
            <li class="last"></li>
          </ul>
            </div>
